...
<html class="no-js" lang="en">
    ...
    <asset:link rel="stylesheet" href="404.css"/>
...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    <h1>404</h1>
    <h3>Hmm... This shouldn't have happened. Let's try again.</h3>
    ...
    <a href="dashboard"><button class="denied__link">Go Home</button></a>
  </div>
<!-- jquery latest version -->
<asset:javascript src="jquery-2.2.4.min.js"/>
<asset:javascript src="404.js"/>
    </body>
</html>
