...
function Upload() {
    ...
    function ProcessExcel(data) {
     ...
     var headerCell = document.createElement("TH");
        ...
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "Contact Number";
        row.appendChild(headerCell);
        ...
        for (var i = 0; i <excelRows.length; i++) { 
            ...
            var cell = row.insertCell(-1);
                    ...
                    editableField.name="tnPId"
                    editableField.classList.add("form-control");
                    editableField.value= excelRows[i].tnPId;
            ...
            cell = row.insertCell(-1);
             var editableField = document.createElement("input")
                    editableField.type="text"
                    editableField.name="contactNumber"
                   editableField.classList.add("form-control");
                    editableField.value= excelRows[i].contactNumber;
                    if(editableField.value=='undefined')
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename+'.xls':'teacherSampleExcel.xls';
